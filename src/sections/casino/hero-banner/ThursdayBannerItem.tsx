...
import {
  ...
  InnerTimeDesc,
  InnerTimeLabel,
  InnerContainer, useNavigateGuard, InnerBannerWrapper, InnerBannerContent
...
export const ThursdayBannerItem = ({ data, content }: {
      ...
      <InnerBannerContent>
        ...
        <InnerContainer className="relative w-50 rounded-lg p-2 mt-2">
          ...
          <InnerConfirmBox
            className={"mt-2"}
            onClick={() => {
              // TODO 目的：加密周四充值只针对加密货币，需要主动激活加密货币存款Tab项目
