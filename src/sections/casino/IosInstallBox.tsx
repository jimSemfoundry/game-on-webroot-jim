      ...
      <div className="flex flex-col gap-8 items-center justify-center py-4">
        ...
        <div className="flex flex-col gap-4">
          ...
          <p className="text-base text-base-content/50 leading-4.5 flex items-center">
            ...
            <span className="px-2">
              <svg width="19" height="18" viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M12.5 2.625C14.364 2.625 15.875 4.13604 15.875 6V12C15.875 13.864 14.364 15.375 12.5 15.375H6.5C4.63604 15.375 3.125 13.864 3.125 12V6C3.125 4.13604 4.63604 2.625 6.5 2.625H12.5Z" stroke="#EBEBEB" strokeWidth="0.75" />
                <path fillRule="evenodd" clipRule="evenodd" d="M9.5 5.625C9.70711 5.625 9.875 5.79289 9.875 6V8.625L12.5 8.625C12.7071 8.625 12.875 8.79289 12.875 9C12.875 9.20711 12.7071 9.375 12.5 9.375L9.875 9.375V12C9.875 12.2071 9.70711 12.375 9.5 12.375C9.29289 12.375 9.125 12.2071 9.125 12V9.375L6.5 9.375C6.29289 9.375 6.125 9.20711 6.125 9C6.125 8.79289 6.29289 8.625 6.5 8.625L9.125 8.625V6C9.125 5.79289 9.29289 5.625 9.5 5.625Z" fill="#EBEBEB" />
              </svg>
            </span>
            <span className="text-white">{t('casino:addHomeScreen')}</span>
          </p>
        </div>
