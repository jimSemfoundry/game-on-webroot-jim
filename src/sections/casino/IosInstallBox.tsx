          ...
          <div
            ...
            dangerouslySetInnerHTML={{
              __html: t("casino:addTo", {
                appName: `<span class="text-primary"> ${import.meta.env.VITE_WEBSITE_NICKNAME_LEFT || "1ST."}</span><span class="text-white">${import.meta.env.VITE_WEBSITE_NICKNAME_RIGHT || "GAME"} </span>`
              })
            }}
          />
