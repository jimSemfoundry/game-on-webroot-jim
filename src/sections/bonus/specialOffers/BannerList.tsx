...
import { BonusCardForH5, BonusCardForPC } from "@/sections/bonus/deposit-bonus/bonus-pool-banner"
import { ThursdaySuperBounsBanner, ThursdaySuperBounsBannerPC } from "@/sections/crypto-thursday-bonus/thursday-bouns-banner"
    ...
    <>
      ...
      }
      {
        currentPromo?.promo_code === 'special_offer_thursday' && (
          <ThursdaySuperBounsBanner currentPromo={currentPromo} />
        )
      }
      {
