...
export const DoubleOrNothingBanner = ({ currentPromo }: { currentPromo: any }) => {
  ...
  return (
    ...
    <div className="w-full h-[138px] rounded-lg relative overflow-hidden border border-primary">
      ...
      <div className="relative pl-4 pt-4">
        ...
        <img src="/images/double-nothing/recoveryBonus.png" className='w-[146px] h-[146px] absolute right-[3px] top-[-3px]' />
      </div>
    </div>
  );
};
...
export const DoubleOrNothingBannerPC = ({ currentPromo }: { currentPromo: any}) => {
  ...
  return (
    <div className="w-[208px] h-[244px] rounded-lg relative overflow-hidden border border-primary">
      ...
      <img src="/images/double-nothing/recoveryBonus.png" className='w-[196px] h-[196px] absolute right-[-58px] bottom-[-21px]' />
