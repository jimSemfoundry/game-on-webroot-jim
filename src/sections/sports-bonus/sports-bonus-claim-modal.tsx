...
export const SportsBonusClaimModal = ({
  open,
  bonus,
  onClick,
  onClose
  ...
  const [status, setStatus] = useState<{ open: boolean; currency: string }>({
    open: false,
    currency: ""
  });
      ...
      <div className="relative">
        ...
        <div className="flex flex-col items-center justify-center rounded-2xl pt-[100px] md:pt-[150px] relative gap-3">
          <div className="text-center">
            ...
            <p className="text-xs font-extrabold text-base-content/50 mt-1">
              {t("bonus:your_bonus", "Claim your Bonus now!")}
            </p>
          </div>
...
const InnerCoinBox = () => {
  return (
    <div className="absolute bottom-[210px] z-[1] left-0 right-0">
