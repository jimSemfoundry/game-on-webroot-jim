  ...
  return (
    <div className="w-full h-[138px] rounded-lg relative overflow-hidden ">
      ...
      <div className="relative px-4 pt-4">
        ...
        <img src="/images/double-nothing/recoveryBonus.png" className='w-[146px] h-[146px] absolute top-[-3px]'
          style={{
...
export const DoubleOrNothingBannerPC = ({ currentPromo }: { currentPromo: any }) => {
  ...
  return (
    <div className="w-[208px] h-[244px] rounded-lg relative overflow-hidden border border-primary">
      ...
      <img src="/images/double-nothing/recoveryBonus.png" className='w-[196px] h-[196px] absolute bottom-[-21px]'
        style={{
          [isRTL ? "left" : "right"]: "-58px",
          transform: isRTL ? "scaleX(-1)" : "none",
        }}
      />
