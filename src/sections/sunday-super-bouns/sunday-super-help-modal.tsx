            ...
            <div className="w-full h-full rounded-lg relative overflow-hidden bg-base-400 ">
              ...
              <div className="relative px-8 h-full">
                <div className="flex flex-col justify-center items-start relative z-10 gap-1 h-full">
                  <p className="text-lg text-base text-base-content font-bold whitespace-pre-line leading-5 text-left">
                    {t('bonus:super_sunday')}
                  </p>
                ...
                <img
                  src="/images/bonus/super-bonus.png"
                  alt="Recovery Bonus"
                  className="w-[194px] h-[163px] absolute top-[-3px]"
                  style={{
        ...
        <div className="bg-base-400 rounded-box relative">
          ...
          <div className="flex flex-col gap-4 px-4 pt-5">
            ...
            <div className="flex items-center gap-2">
              <BonusIcon />
              <h3 className="text-base font-bold text-base-content">{t('popup:offer_details')}</h3>
            </div>
            ...
            <div className="max-h-[400px] overflow-y-auto pb-12 flex flex-col gap-4 hide-scrollbar">
              ...
              <p className="text-xs text-base-content/50 leading-5">
                <Trans
                  ...
                  values={{
                    value: getCashBonusText({ bonus_rate: currentPromo?.bonus_rate }),
              ...
              <div>
                <p className="font-semibold text-sm text-base-content">{t("popup:claim_distribution")}</p>
              ...
              <div>
                <p className="font-semibold text-sm text-base-content">{t("popup:generalTerms")}</p>
                <p className="mt-3 text-base-content/50 text-xs leading-5 whitespace-pre-line">
                  {t("popup:sundayBonus.generalTerms_description")}
                </p>
              </div>
            </div>
          </div>
