...
function UnauthenticatedVipHero() {
  ...
  return (
    <div
      className="relative overflow-hidden rounded-box min-h-[500px] sm:min-h-[400px] flex items-start sm:mx-0 select-none"
    ...
    >
      <div className="container mx-auto px-0 sm:px-20 py-6 sm:py-12">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-8 relative z-100">
          <div className="flex-1 z-10">
            ...
            <button
              className="btn btn-primary btn-lg sm:btn-xl text-base ml-2.5 sm:ml-0 px-8 w-[130px]"
              onClick={openSignInModal}>{t("vip:participate")}</button>
          </div>
        </div>

        <img
          src="/images/illustrations/463f8314ce7d0466e5c028410fc517a52b6343e0.png"
          className="w-[114px] h-[114px] xl:w-[252px] xl:h-[252px] rotate-[-15deg] absolute right-[81px] xl:left-auto bottom-[85px] xl:top-[25px] xl:right-[180px] origin-bottom-right z-40 drop-shadow-2xl pointer-events-none select-none"
          draggable="false"
        />

        <img
          src="/images/illustrations/00c1dc7493acb88558ddaacde45133378d09973d.png"
          className="w-[241px] h-[241px] right-[17px] bottom-[0px] translate-y-[100px] xl:translate-y-0 xl:w-[534px] xl:h-[534px] opacity-30 xl:left-auto absolute xl:right-[38px] xl:top-[150px] object-contain pointer-events-none select-none"
          draggable="false"
        />

        <img
          src="/images/illustrations/58f4a6bfd06fc43064eff747c6489124fff520a2.png"
          className="w-[35px] h-[35px] right-[46px] bottom-[115px] xl:w-[78px] xl:h-[78px] absolute xl:left-auto xl:top-[146px] xl:right-[102px] z-40 object-cover pointer-events-none select-none"
          draggable="false"
        />

        <img
          src="/images/illustrations/58f4a6bfd06fc43064eff747c6489124fff520a3.png"
          className="w-[70px] h-[70px] right-[207px] bottom-[45px] xl:w-[155px] xl:h-[155px] absolute xl:left-auto xl:top-[224px] xl:right-[460px] z-40 pointer-events-none select-none"
          draggable="false"
        />
        <img
          src="/images/illustrations/44285e1a15e8a0743705e017bbcef43e8bc2546d.png"
          className="w-[41px] h-[41px] bottom-[30px] right-[33px] xl:w-[90px] xl:h-[90px] rotate-[18deg] absolute xl:right-[73px] xl:top-[295px] pointer-events-none select-none"
          draggable="false"
        />
        <div
          className="absolute hidden xl:block w-[659px] h-[659px] right-[-87px] top-[336px] bg-primary blur-[215px] rounded-full transform-gpu" />
        <div
          className="absolute block xl:hidden w-[297px] h-[297px] right-[-40px] bottom-0 translate-y-[229px] blur-[97px] bg-primary opacity-50 transform-gpu" />
        <div
          className="absolute xl:top-[243px] xl:right-[175px] shrink-0 origin-bottom-right text-base-300 hidden xl:block">
        ...
        <div className="absolute bottom-[60px] right-[76px] shrink-0 text-base-300 block xl:hidden">
...
function AuthenticatedVipHero() {
  ...
  return (
    <div
      className="relative sm:mt-18 rounded-box sm:bg-base-200/50 min-h-[368px] xl:min-h-[234px] select-none touch-none"
      style={{
    ...
    >
      <div className="relative w-full h-full">
        ...
        <div
          className="flex-1 flex flex-col lg:flex-row items-center lg:items-start gap-4 sm:gap-6 absolute z-100 left-[30px] sm:left-[50px] top-1/2 translate-y-1/2">
          {/* Rewards Info */}
        ...
        {/* 右侧：VIP Progress */}
        <div
          className="min-h-[200px] top-[167px] left-0 right-0 z-0 sm:mx-0 absolute xl:w-[600px] xl:right-4 xl:left-auto xl:rtl:right-auto xl:rtl:left-4 xl:top-4 xl:bottom-2 xl:h-[calc(100%-2rem)] xl:bg-base-300 xl:rounded-box">
          <LiquidGlassEffect
