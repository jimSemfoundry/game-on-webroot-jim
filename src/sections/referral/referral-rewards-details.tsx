...
import { IReferralRewardsDetail, ReferralRewardsRecord } from '@/types/referral';
import { useTranslation } from 'react-i18next';
import dayjs from 'dayjs';
import { useDisplayCurrencyFormatter } from "@/hooks/currency";

export default function ReferralRewardsDetailsPage({ item, isOpen, onClose }: { item: ReferralRewardsRecord | null, isOpen: boolean, onClose: () => void }) {
  ...
  useEffect(() => {
    setLoading(true);
    authService.getReferralRewardDetail({ id: item?.id, created_at: item?.created_at }).then((res: any) => {
              ...
              <div className="flex flex-col gap-1 py-2">
                ...
                <div className="flex h-6 items-center justify-between px-4">
                  ...
                  <div className="text-primary text-sm font-semibold">
                    ...
                    {formatWithoutConversion(referralDetail?.rewards_unlocked ?? 0, "USD", {
                      showSymbol: false,
                      showCode: true,
