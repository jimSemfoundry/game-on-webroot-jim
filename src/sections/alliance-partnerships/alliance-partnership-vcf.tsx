...
export const AlliancePartnershipVCF = () => {
  ...
  // Villarreal CF 相关图片和视频数据
  const vcfItems: CarouselItem[] = [
    {
      id: 1,
      type: 'video',
      src: 'e69de8d13a86caa2fada4b0ce457b3e1',
      title: 'VCF',
      description: 'VCF',
    },
    {
      id: 2,
      type: 'image',
      src: '/images/alliance/vcf-banner-1.png',
      title: 'VCF',
      description: 'VCF',
    },
    {
      id: 3,
      type: 'image',
      src: '/images/alliance/vcf-banner-2.png',
      title: 'VCF',
      description: 'VCF',
    },
    {
      id: 4,
      type: 'image',
      src: '/images/alliance/vcf-banner-3.png',
      title: 'VCF',
      description: 'VCF',
    },
    {
      id: 5,
      type: 'image',
      src: '/images/alliance/vcf-banner-4.png',
      title: 'VCF',
      description: 'VCF',
    },
  ];
  ...
  return (
    <div className="p-4 flex flex-col gap-3 sm:gap-6">
      <div className="relative h-[209px] overflow-hidden xs:h-[209px] sm:h-[420px] rounded-box w-full rtl:rotate-y-180">
        {/** Title */}
        <div className="font-bold text-xl sm:text-7xl leading-6 sm:leading-18 whitespace-pre-line absolute top-1/2 -translate-y-1/2 sm:left-[150px] left-[35px] sm:p-6 z-50 rtl:rotate-y-180">
          <img src="/images/alliance/vcf-logo.png" alt="vcf title" className="w-[57px] h-[72px] sm:w-[161px] sm:h-[200px] object-cover" />
        </div>
        {/** Illustration */}
        <img
          src="/images/alliance/vcf-mobile.png"
          alt="suarez mobile"
          className="absolute right-0 z-20 top-0 w-[253px] object-cover sm:hidden"
        />
        <img
          src="/images/alliance/vcf-desktop.png"
          alt="suarez desktop"
          className="absolute right-13 z-20 top-0 w-[673px] object-cover hidden sm:block"
        />
        {/** Background */}
        <div
              ...
              >
                {item.type === 'image' ? (
                  <img
                    ...
                    onError={(e) => {
                      // 如果图片加载失败，使用占位图
                      (e.target as HTMLImageElement).src = "/images/alliance/vcf-mobile.png";
                    }}
                  />
                ) : (
