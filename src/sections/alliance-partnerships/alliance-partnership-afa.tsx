...
export const AlliancePartnershipAFA = () => {
  ...
  // AFA 相关图片和视频数据
  const afaItems: CarouselItem[] = [
    {
      id: 1,
      type: 'video',
      src: 'c3faa786c2b512ae6e886f93f1029a40',
      thumbnail: '/images/alliance/afa-banner-0.png',
      title: 'AFA',
      description: 'AFA',
    },
    {
      id: 2,
      type: 'image',
      src: '/images/alliance/afa-banner-1.png',
      title: 'AFA',
      description: 'AFA',
    },
    {
      id: 3,
      type: 'image',
      src: '/images/alliance/afa-banner-2.png',
      title: 'AFA',
      description: 'AFA',
    },
    {
      id: 4,
      type: 'image',
      src: '/images/alliance/afa-banner-3.png',
      title: 'AFA',
      description: 'AFA',
    },
    {
      id: 5,
      type: 'image',
      src: '/images/alliance/afa-banner-4.png',
      title: 'AFA',
      description: 'AFA',
    },
    {
      id: 6,
      type: 'image',
      src: '/images/alliance/afa-banner-5.png',
      title: 'AFA',
      description: 'AFA',
    },
    {
      id: 7,
      type: 'image',
      src: '/images/alliance/afa-banner-6.png',
      title: 'AFA',
      description: 'AFA',
    },
    {
      id: 8,
      type: 'image',
      src: '/images/alliance/afa-banner-7.png',
      title: 'AFA',
      description: 'AFA',
    },
    {
      id: 9,
      type: 'image',
      src: '/images/alliance/afa-banner-8.png',
      title: 'AFA',
      description: 'AFA',
    },
  ];
  ...
  useEffect(() => {
    ...
    return () => {
      emblaApi
        ...
        .off("select", handleCarouselChange);
    };
  }, [carousel.mainApi, setTweenNodes, setTweenFactor, tweenScale, handleCarouselChange]);
  ...
  return (
    <div className="p-4 flex flex-col gap-3 sm:gap-6">
      <div className="relative h-[209px] overflow-hidden xs:h-[209px] sm:h-[420px] rounded-box w-full rtl:rotate-y-180">
        {/** Title */}
        <div className="font-bold text-xl sm:text-7xl leading-6 sm:leading-18 whitespace-pre-line absolute top-1/2 -translate-y-1/2 sm:left-[240px] left-[35px] sm:p-6 z-50 rtl:rotate-y-180">
          <img src="/images/alliance/afa-logo.png" alt="afa title" className="w-[55px] h-[78px] sm:w-[160px] sm:h-[229px] object-cover" />
        </div>
        {/** Illustration */}
        <img
          src="/images/alliance/afa-mobile.png"
          alt="suarez mobile"
          className="absolute right-0 z-20 bottom-0 w-[231px] object-cover sm:hidden"
        />
        <img
          src="/images/alliance/afa-desktop.png"
          alt="suarez desktop"
          className="absolute right-13 z-20 top-0 w-[643px] object-cover hidden sm:block"
        />
        {/** Background */}
        <div
              ...
              >
                {item.type === 'image' ? (
                  <img
                    ...
                    onError={(e) => {
                      // 如果图片加载失败，使用占位图
                      (e.target as HTMLImageElement).src = "/images/alliance/afa-mobile.png";
                    }}
                  />
                ) : (
                      ...
                      {!isPlaying && (
                        <>
                          ...
                          <img
                            ...
                            src="/images/alliance/play-button.png"
                            alt="Play"
                          />
                        </>
                      )}
