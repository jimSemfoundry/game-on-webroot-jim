...
import { ReferralProgramGuard } from "@/sections/profile/dashboard/ReferralProgramGuard.tsx";
...
export function ReferralProgram() {
  ...
  return (
    <ReferralProgramGuard>
      <Card title={t("common.referralProgram")}
            icon={<Iconify icon="custom:profile-referral-program" className="text-primary" />}
          ...
          <SmallLoading
            ...
            content={<div className="flex gap-1 items-center">
              <p
                ...
                className="hide-scrollbar whitespace-nowrap flex-1 overflow-x-scroll bg-base-200 rounded-md p-2 text-xs text-base-content/50 font-semibold md:max-w-50">{referralLink}</p>
