  ...
  },
  {
    ...
    text: {
      ...
      content: t("responsibleGaming:introducingOurResponsibleGamblingTools.content", {
        gameLink: `<a target="_blank" href="${import.meta.env.VITE_WEBSITE_URL || "https://1st.game"}" class="text-primary font-bold text-sm">${import.meta.env.VITE_WEBSITE_NICKNAME || "1st.game"}</a>`,
        supportEmailLink: `<a target="_blank" href="mailto:${import.meta.env.VITE_WEBSITE_SUPPORT_EMAIL || "support@1st.game"}" class="text-primary font-bold text-sm">${import.meta.env.VITE_WEBSITE_SUPPORT_EMAIL || "support@1st.game"}</a>`,
        anonymousLink: `<a target="_blank" href="${import.meta.env.VITE_WEBSITE_ANONYMOUS || "https://gamblersanonymous.org/ga/"}" class="text-primary font-bold text-sm">${import.meta.env.VITE_WEBSITE_ANONYMOUS || "https://gamblersanonymous.org/ga/"}</a>`,
        therapyLink: `<a target="_blank" href="${import.meta.env.VITE_WEBSITE_THERAPY || "https://www.gamblingtherapy.org/"}" class="text-primary font-bold text-sm">${import.meta.env.VITE_WEBSITE_THERAPY || "https://www.gamblingtherapy.org/"}</a>`,
        therapyEmailLink: `<a target="_blank" href="mailto:${import.meta.env.VITE_WEBSITE_THERAPY_EMAIL || "support@gamblingtherapy.org"}" class="text-primary font-bold text-sm">${import.meta.env.VITE_WEBSITE_THERAPY_EMAIL || "support@gamblingtherapy.org"}</a>`,
        chatLink: `<a target="_blank" href="${import.meta.env.VITE_WEBSITE_CHAT || "https://www.ncpgambling.org/help-treatment/chat/"}" class="text-primary font-bold text-sm">${import.meta.env.VITE_WEBSITE_CHAT || "https://www.ncpgambling.org/help-treatment/chat/"}</a>`,
        supportLink: `<a target="_blank" href="${import.meta.env.VITE_WEBSITE_SUPPORT || "https://www.gamtalk.org/treatment-support/"}" class="text-primary font-bold text-sm">${import.meta.env.VITE_WEBSITE_SUPPORT || "https://www.gamtalk.org/treatment-support/"}</a>`,
        tel: import.meta.env.VITE_WEBSITE_TEL || "+18004262537"
  ...
  },
  {
    ...
    text: {
      ...
      content: t("responsibleGaming:minors.content", {
        ...
        minorsAge: 18,
        blocksLink: `<a target="_blank" href="${import.meta.env.VITE_WEBSITE_BLOCKS_URL || "https://www.betblocker.org/"}" class="text-primary font-bold text-sm">${import.meta.env.VITE_WEBSITE_BLOCKS_URL || "https://www.betblocker.org/"}</a>`,
        netnannyLink: `<a target="_blank" href="${import.meta.env.VITE_WEBSITE_NETNANNY_URL || "https://www.netnanny.com/"}" class="text-primary font-bold text-sm">${import.meta.env.VITE_WEBSITE_NETNANNY_URL || "https://www.netnanny.com/"}</a>`,
        gamblockLink: `<a target="_blank" href="${import.meta.env.VITE_WEBSITE_GAMBLOCK_URL || "http://www.gamblock.com/"}" class="text-primary font-bold text-sm">${import.meta.env.VITE_WEBSITE_GAMBLOCK_URL || "http://www.gamblock.com/"}</a>`
      }),
      open: false
      //       content: `
      //       <p class="leading-7">
