  ...
  return (
    <div className="w-full h-[138px] rounded-lg relative overflow-hidden ">
      ...
      <div className="relative px-4 pt-4">
        ...
        <img src="/images/bonus/crypto.png" className='w-[160px] h-[150px] absolute top-[-3px]'
          style={{
...
export const ThursdaySuperBounsBannerPC = ({ currentPromo }: { currentPromo: any }) => {
  ...
  return (
    <div className="w-[208px] h-[244px] rounded-lg relative overflow-hidden border border-primary">
      ...
      <img src="/images/bonus/crypto-pc.png" className='w-[172px] h-[159px] absolute bottom-[0px]'
        style={{
