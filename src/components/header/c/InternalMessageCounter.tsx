...
export default function InternalMessageCounter({ onClick }: { onClick: () => void }) {
  ...
  return (
    <div className="indicator cursor-pointer z-40 bg-base-200 rounded-lg w-8 h-8 md:w-10 md:h-10 flex items-center justify-center" onClick={onClick}>
      <img src="/icons/ui/bell.svg" alt="" className="w-6 h-6 md:w-8 md:h-8" />
      {
        unreadCounter?.unread_count > 0 && (
          <m.span
            ...
            badge-primary !rounded-sm p-0 z-20 md:h-4 h-3.5
