...
const matchTheme = [
  ...
  {
    icon: {
      "crypto-baron.png": ["bonus_dollars", "dollars"]
    },
    background: "radial-gradient(60.05% 100% at 0% 46.47%, color(display-p3 0.9765 0.7255 0.2196 / 0.40) 0%, var(--d-color-base-3000, color(display-p3 0.0627 0.0784 0.098 / 0.00)) 100%), var(--d-color-base-300, color(display-p3 0.0627 0.0784 0.098))"
  },
  {
    icon: {
      "crypto-baron.png": ["recovery_bonus", "recovery"]
    },
    background: "radial-gradient(60.05% 100% at 0% 46.47%, color(display-p3 0.0863 0.8549 1 / 0.40) 0%, var(--d-color-base-3000, color(display-p3 0.0627 0.0784 0.098 / 0.00)) 100%), var(--d-color-base-300, color(display-p3 0.0627 0.0784 0.098))"
  },
  {
    icon: {
      "crypto-baron.png": ["crypto_thursday", "thursday"]
    },
    background: "radial-gradient(60.05% 100% at 0% 46.47%, color(display-p3 0.2118 0.702 0.5725 / 0.40) 0%, var(--d-color-base-3000, color(display-p3 0.0627 0.0784 0.098 / 0.00)) 100%), var(--d-color-base-300, color(display-p3 0.0627 0.0784 0.098))"
  },
  {
    icon: {
      "crypto-baron.png": ["super_sunday", "sunday"]
    },
    background: "radial-gradient(60.05% 100% at 0% 46.47%, color(display-p3 0.902 0.1882 0.5725 / 0.40) 0%, var(--d-color-base-3000, color(display-p3 0.0627 0.0784 0.098 / 0.00)) 100%), var(--d-color-base-300, color(display-p3 0.0627 0.0784 0.098))"
  },
  {
    icon: {
      "crypto-baron.png": ["monday_vip_bonus", "Monday_announcement"]
    },
    background: "radial-gradient(80.05% 100% at 0% 46.47%, color(display-p3 0.9373 0.4078 0.0275 / 0.30) 0%, var(--d-color-base-3000, color(display-p3 0.0627 0.0784 0.098 / 0.00)) 100%), var(--d-color-base-300, color(display-p3 0.0627 0.0784 0.098))"
  }
];
