...
import { SwapSend } from "@/components/modal/BonusWallet/BonusSwapModal/SwapSend.tsx";
...
const SportsBonusSwapModal = ({
  ...
  const showSuccessToast = useCallback(
    (amount: string) => {
      ...
      showBaseToast({
        icon: "/images/dollars/sport-success.png",
    ...
    <Modal
      title={
        <div className="flex items-center gap-2">
          <img src="/images/bonus/sport.png" alt="" className="w-5 h-5" />
