/**
 * Standardized error codes for authentication and password-related operations
 * Error codes 60004-60012 are reserved for authentication errors
 */

export const AUTH_ERROR_CODES = {
  TOO_MANY_REQUESTS_CODE: 429,

  MOBILE_ALREADY_BOUND_ERROR: 60001,
...
export const CODE_INPUT_PARAM_ERROR = AUTH_ERROR_CODES.INPUT_PARAM_ERROR;
export const CODE_EMAIL_OR_MOBILE_TYPE_ERROR = AUTH_ERROR_CODES.EMAIL_OR_MOBILE_TYPE_ERROR;
export const CODE_USERNAME_OR_PASSWORD_ERROR = AUTH_ERROR_CODES.USERNAME_OR_PASSWORD_ERROR;
export const CODE_DEFAULT_ERROR = AUTH_ERROR_CODES.DEFAULT_ERROR;
export const CODE_INPUT_PIN_IS_NOT_EXIST = AUTH_ERROR_CODES.INPUT_PIN_IS_NOT_EXIST;
export const CODE_INPUT_CONFIRM_PIN_IS_NOT_EXIST = AUTH_ERROR_CODES.INPUT_CONFIRM_PIN_IS_NOT_EXIST;
export const CODE_INPUT_CONFIRM_PIN_DO_NOT_MATCH = AUTH_ERROR_CODES.INPUT_CONFIRM_PIN_DO_NOT_MATCH;
export const CODE_USER_NOT_FOUND = AUTH_ERROR_CODES.USER_NOT_FOUND;
export const CODE_INCORRECT_CURRENT_PASSWORD = AUTH_ERROR_CODES.INCORRECT_CURRENT_PASSWORD;
export const CODE_NEW_PASSWORD_AND_CONFIRM_PASSWORD_DO_NOT_MATCH = AUTH_ERROR_CODES.CODE_NEW_PASSWORD_AND_CONFIRM_PASSWORD_DO_NOT_MATCH;
export const CODE_NEW_PASSWORD_AND_CURRENT_PASSWORD_AS_SAME = AUTH_ERROR_CODES.CODE_NEW_PASSWORD_AND_CURRENT_PASSWORD_AS_SAME;
export const CODE_INVALID_OR_EXPIRED_VERIFICATION_CODE = AUTH_ERROR_CODES.CODE_INVALID_OR_EXPIRED_VERIFICATION_CODE;

/**
 * Helper function to get error message key based on error code
 * @param errorCode - The error code from the API response
 * @returns The corresponding translation key
 */
export function getAuthErrorMessageKey(errorCode: number): string {
  switch (errorCode) {
