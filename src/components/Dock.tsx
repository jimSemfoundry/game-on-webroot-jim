import { LIVE_NAV_ITEMS, MAIN_NAV_ITEMS, type NavItem } from "@/config/navigation";
...
const InnerDockGuard = ({ item, isActive, onClick }: {
  item: DockItem,
  isActive: boolean,
  ...
  >
    <Iconify icon={_item.icon} width={18} height={18} />
    <span
      className="text-xs font-bold text-base-content truncate max-w-full overflow-hidden whitespace-nowrap">{t(_item.label)}</span>
    <InnerBonusLabel label={_item.href} />
  </button>;
};